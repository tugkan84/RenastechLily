...
public class assignement_while {
    ...
    //-(while) This should be done for each student
    ...
    public static void main(String[] args) {
        ...
        while (ask) {
            System.out.println("Enter The Student's First Name: (or type e for exit)");
        ...
        System.out.println("You exit the Student Grade Calculate Program");
